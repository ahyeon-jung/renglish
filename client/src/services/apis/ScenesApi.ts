...
export class ScenesApi extends runtime.BaseAPI {
   ...
   * 장면에 스터디 추가하기  [ADMIN]
   */
  async sceneControllerAddStudyRaw(
   ...
   * 스터디 생성하기  [ADMIN]
   */
  async sceneControllerCreateRaw(
   ...
   * 장면 정보 생성하기 [ADMIN]
   */
  async sceneControllerCreateSceneRaw(
   ...
   * 장면 정보 생성하기 [ADMIN]
   */
  async sceneControllerCreateScene(
    requestParameters: SceneControllerCreateSceneRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<void> {
   ...
   * 장면 삭제하기 [ADMIN]
   */
  async sceneControllerDeleteSceneRaw(
   ...
   * 장면 삭제하기 [ADMIN]
   */
  async sceneControllerDeleteScene(
    requestParameters: SceneControllerDeleteSceneRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<void> {
   ...
   * 장면 발화자 가져오기
   */
  async sceneControllerFindAllRaw(
   ...
   * 모든 장면 가져오기
   */
  async sceneControllerFindAllSceneRaw(
   ...
   * 모든 장면 가져오기
   */
  async sceneControllerFindAllScene(
    requestParameters: SceneControllerFindAllSceneRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<void> {
   ...
   * 장면 및 대본 가져오기
   */
  async sceneControllerFindSceneByIdRaw(
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      ExtendedSceneDtoFromJSON(jsonValue),
    );
  }
   ...
   * 장면 및 대본 가져오기
   */
  async sceneControllerFindSceneById(
    requestParameters: SceneControllerFindSceneByIdRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<ExtendedSceneDto> {
   ...
   * 장면 정보 변경하기
   */
  async sceneControllerUpdateDialogueRaw(
    requestParameters: SceneControllerUpdateDialogueRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['sceneId'] == null) {
      throw new runtime.RequiredError(
   ...
   * 장면 정보 변경하기
   */
  async sceneControllerUpdateDialogue(
    requestParameters: SceneControllerUpdateDialogueRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<void> {
