...
export class DialoguesApi extends runtime.BaseAPI {
     ...
     * 대사 정보 생성 [ADMIN]
     */
    async dialogueControllerCreateDialogueRaw(requestParameters: DialogueControllerCreateDialogueRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
     ...
     * 대사 정보 생성 [ADMIN]
     */
    async dialogueControllerCreateDialogue(requestParameters: DialogueControllerCreateDialogueRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
     ...
     * 대사 정보 변경 [ADMIN]
     */
    async dialogueControllerUpdateDialogueRaw(requestParameters: DialogueControllerUpdateDialogueRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
     ...
     * 대사 정보 변경 [ADMIN]
     */
    async dialogueControllerUpdateDialogue(requestParameters: DialogueControllerUpdateDialogueRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
