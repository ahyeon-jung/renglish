...
export class MyApi extends runtime.BaseAPI {
     ...
     */
    async myControllerFindMyWritingsRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<WritingDto>>> {
        const queryParameters: any = {};
     ...
     * 사용자가 작성한 작문 목록 [TOKEN]
     */
    async myControllerFindMyWritings(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<WritingDto>> {
