...
import type { CreateExpressionDto, UpdateExpressionDto } from '../models/index';
import {
...
export class ExpressionApi extends runtime.BaseAPI {
   ...
   * 영어 표현 추가하기 [ADMIN]
   */
  async expressionControllerCreateRaw(
   ...
   * 영어 표현 추가하기 [ADMIN]
   */
  async expressionControllerCreate(
    requestParameters: ExpressionControllerCreateRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<void> {
   ...
   * 이번주 영어 표현 가져오기
   */
  async expressionControllerFindAllRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<void>> {
    const queryParameters: any = {};
   ...
   * 이번주 영어 표현 가져오기
   */
  async expressionControllerFindAll(
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<void> {
   ...
   */
  async expressionControllerFindExpressionBySceneIdRaw(
   ...
   * 해당 장면의 영어 표현 가져오기 [TOKEN]
   */
  async expressionControllerFindExpressionBySceneId(
    requestParameters: ExpressionControllerFindExpressionBySceneIdRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<void> {
   ...
   * 영어 표현 삭제하기 [ADMIN]
   */
  async expressionControllerRemoveRaw(
   ...
   * 영어 표현 삭제하기 [ADMIN]
   */
  async expressionControllerRemove(
    requestParameters: ExpressionControllerRemoveRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<void> {
   ...
   * 영어 표현 수정하기 [ADMIN]
   */
  async expressionControllerUpdateRaw(
   ...
   * 영어 표현 수정하기 [ADMIN]
   */
  async expressionControllerUpdate(
    requestParameters: ExpressionControllerUpdateRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<void> {
