...
export function UpdateDialogueDtoFromJSONTyped(json: any, ignoreDiscriminator: boolean): UpdateDialogueDto {
    if (json == null) {
        return json;
    }
    return {
...
export function UpdateDialogueDtoToJSONTyped(value?: UpdateDialogueDto | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
