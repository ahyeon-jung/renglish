...
export declare class MoviesApi extends runtime.BaseAPI {
     ...
     * 가장 최신 영화 가져오기
     */
    movieControllerFindLatestSceneRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Movie>>;
    /**
     * 가장 최신 업로드된 장면의 영화 정보를 가져옵니다.
     * 가장 최신 영화 가져오기
     */
    movieControllerFindLatestScene(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Movie>;
    /**
