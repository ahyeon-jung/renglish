...
export declare class ScenesApi extends runtime.BaseAPI {
   ...
   * 모든 장면 가져오기
   */
  sceneControllerFindAllSceneRaw(
   ...
   * 장면 및 대본 가져오기
   */
  sceneControllerFindSceneByIdRaw(
