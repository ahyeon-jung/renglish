...
export function ExtendedFilteredStudyDtoFromJSONTyped(
  json: any,
  ignoreDiscriminator: boolean,
): ExtendedFilteredStudyDto {
  if (json == null) {
    return json;
  }
  return {
...
export function ExtendedFilteredStudyDtoToJSONTyped(
  value?: ExtendedFilteredStudyDto | null,
