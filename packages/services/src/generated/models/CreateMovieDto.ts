...
export function CreateMovieDtoFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateMovieDto {
    if (json == null) {
        return json;
    }
    return {
...
export function CreateMovieDtoToJSONTyped(value?: CreateMovieDto | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
