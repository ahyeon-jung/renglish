...
export function CreateWritingDtoFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateWritingDto {
    if (json == null) {
        return json;
    }
    return {
...
export function CreateWritingDtoToJSONTyped(value?: CreateWritingDto | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
