...
export class SpeakersApi extends runtime.BaseAPI {
   ...
   * 발화자 정보 생성 [ADMIN]
   */
  async speakerControllerCreateSpeakerRaw(
   ...
   * 발화자 정보 생성 [ADMIN]
   */
  async speakerControllerCreateSpeaker(
    requestParameters: SpeakerControllerCreateSpeakerRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<void> {
   ...
   * 발화자 정보 가져오기
   */
  async speakerControllerFindOneRaw(
   ...
   * 발화자 정보 가져오기
   */
  async speakerControllerFindOne(
    requestParameters: SpeakerControllerFindOneRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<void> {
   ...
   * 발화자 정보를 가져옵니다.
   */
  async speakerControllerFindSpeakersRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
   ...
   * 발화자 정보를 가져옵니다.
   */
  async speakerControllerFindSpeakers(
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
   ...
   * 발화자 정보 변경하기 [ADMIN]
   */
  async speakerControllerUpdateRaw(
