...
export class MoviesApi extends runtime.BaseAPI {
     ...
     * 영화 정보 생성 [TOKEN]
     */
    async movieControllerCreateRaw(requestParameters: MovieControllerCreateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Movie>> {
     ...
     * 영화 정보 생성 [TOKEN]
     */
    async movieControllerCreate(requestParameters: MovieControllerCreateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Movie | null | undefined > {
     ...
     * 모든 영화 정보 가져오기
     */
    async movieControllerFindAllRaw(requestParameters: MovieControllerFindAllRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<PaginationMovieResponseDto>> {
     ...
     * 모든 영화 정보 가져오기
     */
    async movieControllerFindAll(requestParameters: MovieControllerFindAllRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<PaginationMovieResponseDto> {
     ...
     * 영화 아이디로 영화 정보 찾기
     */
    async movieControllerFindOneRaw(requestParameters: MovieControllerFindOneRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Movie>> {
     ...
     * 영화 아이디로 영화 정보 찾기
     */
    async movieControllerFindOne(requestParameters: MovieControllerFindOneRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Movie> {
     ...
     * 영화 정보 삭제 [TOKEN]
     */
    async movieControllerRemoveRaw(requestParameters: MovieControllerRemoveRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Movie>> {
        if (requestParameters['movieId'] == null) {
            throw new runtime.RequiredError(
                'movieId',
     ...
     * 영화 정보 삭제 [TOKEN]
     */
    async movieControllerRemove(requestParameters: MovieControllerRemoveRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Movie> {
     ...
     * 영화 이미지 추가 [TOKEN]
     */
    async movieControllerUpdateImageUrlRaw(requestParameters: MovieControllerUpdateImageUrlRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Movie>> {
        if (requestParameters['movieId'] == null) {
            throw new runtime.RequiredError(
                'movieId',
     ...
     * 영화 이미지 추가 [TOKEN]
     */
    async movieControllerUpdateImageUrl(requestParameters: MovieControllerUpdateImageUrlRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Movie> {
