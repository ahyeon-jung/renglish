...
export class StatisticsApi extends runtime.BaseAPI {
   ...
   * 방문자 row 추가(관리자 전용)
   */
  async statisticControllerCreateStaticsRowRaw(
   ...
   * 방문자 row 추가(관리자 전용)
   */
  async statisticControllerCreateStaticsRow(
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<void> {
   ...
   * 방문자 수 조회하기
   */
  async statisticControllerGetVisitorCountRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<void>> {
    const queryParameters: any = {};
   ...
   * 방문자 수 조회하기
   */
  async statisticControllerGetVisitorCount(
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<void> {
   ...
   * 방문자 수 업데이트하기
   */
  async statisticControllerUpdateVisitorCountRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<void>> {
    const queryParameters: any = {};
   ...
   * 방문자 수 업데이트하기
   */
  async statisticControllerUpdateVisitorCount(
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<void> {
