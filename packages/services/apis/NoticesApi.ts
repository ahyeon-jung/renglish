...
export class NoticesApi extends runtime.BaseAPI {
   ...
   * 공지사항 작성 [ADMIN]
   */
  async noticeControllerCreateRaw(
   ...
   * 모든 공지사항 가져오기
   */
  async noticeControllerFindAllRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<void>> {
    const queryParameters: any = {};
   ...
   * 해당 ID 공지사항 가져오기
   */
  async noticeControllerFindOneRaw(
   ...
   * 해당 ID 공지사항 삭제 [ADMIN]
   */
  async noticeControllerRemoveRaw(
   ...
   * 공지사항 수정 [ADMIN]
   */
  async noticeControllerUpdateRaw(
