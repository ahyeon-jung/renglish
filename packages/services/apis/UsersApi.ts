...
export class UsersApi extends runtime.BaseAPI {
   ...
   * 이메일로 사용자 찾기
   */
  async userControllerCheckExistByEmailRaw(
   ...
   * 이메일로 사용자 찾기
   */
  async userControllerCheckExistByEmail(
    requestParameters: UserControllerCheckExistByEmailRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<void> {
   ...
   * 모든 사용자 정보 가져오기
   */
  async userControllerFindAllRaw(
   ...
   * 아이디로 사용자 찾기
   */
  async userControllerFindUserByIdRaw(
   ...
   * 아이디로 사용자 찾기
   */
  async userControllerFindUserById(
    requestParameters: UserControllerFindUserByIdRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<void> {
